...
ck('TrackCursor(next.dir' in arcs and
   'ReconcileReceipt(trans.deal,deleted,true,why)' in arcs and
   'ReplayAfterCursor(recovery_CORE_BUY,overlapWhy)' in arcs and
   'ReplayAfterCursor(recovery_CORE_SELL,overlapWhy)' in arcs,
   'F03 callback uses one receipt and periodic overlap covers both directions')
