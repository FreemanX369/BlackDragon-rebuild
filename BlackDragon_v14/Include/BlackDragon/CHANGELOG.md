...
## T17.25 — PR28 full source completion — 2026-09-06

- Version 15.02; durable protected-operation outcome/ACK and atomic replay receipts with corrections.
- Indexed PositionBook, incremental campaign reducer, bounded settled/receipt retention and persisted retry.
- Default-OFF local diagnostics, validation-only broker profit oracle and paired native benchmark validator.
- Host: 59 groups / 232 production assertions / 11 killed mutations / 12 UBSan fixtures. Native: 34 suites enrolled, compile deferred to owner; no release or measured-speedup claim.
- Migration/rollback and full R001–R018 status in docs/vibecode/BD_PR28_REMEDIATION.
